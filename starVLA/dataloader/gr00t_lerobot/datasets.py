...
LE_ROBOT_STATS_FILENAME = "meta/stats_gr00t.json" # "meta/stats.json"
...
def calculate_dataset_statistics(parquet_paths: list[Path]) -> dict:
    ...
    for le_modality in tqdm(all_low_dim_data.columns, desc="Processing modalities"):
        ...
        # Skip modalities that cannot be represented as stacked float32 arrays.
        try:
            np_data = np.vstack(
...
class LeRobotSingleDataset(Dataset):
    ...
    def _get_metadata(self, embodiment_tag: EmbodimentTag) -> DatasetMetadata:
        ...
        # Reuse valid cached statistics when available.
        ...
        # Rank 0 computes and atomically caches missing statistics.
        ...
        # Other ranks wait until the cache is complete.
        if dist.is_initialized():
            dist.barrier()

        # Load the cache produced by rank 0 after synchronization.
        ...
        # v3.0
            ...
            for file_path in file_paths:
                ...
                for index, episode in episodes_data.iterrows():
                    ...
                    # Keep the shard coordinates required to locate this v3 episode.
                    episode_meta = {
    ...
    def _get_all_steps(self) -> list[tuple[int, int]]:
        ...
        # Reuse a valid step index cache when available.
        ...
        # Rank 0 builds and atomically writes a missing cache.
        if is_main():
        ...
        # Every rank loads the completed cache.
        with open(steps_path, "rb") as f:
            cached_data = pickle.load(f)
    ...
    def _get_all_steps_single_process(self) -> list[tuple[int, int]]:
        ...
        # Use manifest lengths so public indices remain aligned with dataset metadata.
    ...
    def get_step_data(self, trajectory_id: int, base_index: int) -> dict:
        ...
        # Load the episode once, then extract each configured modality from it.
