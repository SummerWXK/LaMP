...
DATASET_NAMED_MIXTURES = {
    ...
    "flexiv_teleop_new_v3": [
        ("teleop_new_v3_lerobot", 1.0, "flexiv_robot"),
    ],
    "custom_dataset": [
    ...
    "libero_all": [
        ("libero_object_no_noops_lerobot", 1.0, "libero_franka"),
        ("libero_goal_no_noops_lerobot", 1.0, "libero_franka"),
        ("libero_spatial_no_noops_lerobot", 1.0, "libero_franka"),
        ("libero_10_no_noops_lerobot", 1.0, "libero_franka"),
    ...
    #     ("bridge_orig_lerobot", 1.0, "oxe_bridge"),
    #     ("fractal20220817_data_lerobot", 1.0, "oxe_rt1"),
    #     ("droid_lerobot", 1.0, "oxe_droid"),
    #     ("berkeley_fanuc_manipulation_lerobot", 1.0, "libero_franka"),
    #     ("furniture_bench_dataset_lerobot", 1.0, "libero_franka"),
    #     ("iamlab_cmu_pickup_insert_lerobot", 1.0, "libero_franka"),
    #     ("stanford_hydra_dataset_lerobot", 1.0, "libero_franka"),
    #     ("utaustin_mutex_lerobot", 1.0, "libero_franka"),
    #     ("viola_lerobot", 1.0, "libero_franka"),
    # ],
