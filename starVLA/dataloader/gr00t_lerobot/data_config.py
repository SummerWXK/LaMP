...
class OxeBridgeDataConfig:
    ...
    observation_indices = [0]
    action_indices = list(range(30)) # 16
...
class FlexivRobotDataConfig:
    ...
    def transform(self):
        transforms = [
            ...
            # Enable this optional transform when downstream consumers require concatenated tensors.
            # ConcatTransform(
            #     video_concat_order=self.video_keys,
            #     state_concat_order=self.state_keys,
            #     action_concat_order=self.action_keys,
...
ROBOT_TYPE_CONFIG_MAP = {
    ...
    "flexiv_robot": FlexivRobotDataConfig(),
